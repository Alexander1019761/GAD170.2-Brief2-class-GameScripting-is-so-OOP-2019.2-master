...
public class BattleLogic : MonoBehaviour
{
    ...
    // TODO: Create more prefabs in the Unity editor and add to the following arrays so they can be instantiated into the battle. Y
    public CharacterStats[] heroLibrary;
    public CharacterStats[] monsterLibrary;

    // TODO: In the Unity editor, populate the following arrays with spawn points where you want the heroes and monsters to be instantiated. Y
